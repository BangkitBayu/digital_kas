                ...
                <form method="POST" class=" w-full p-2 flex-col space-y-2">
                    ...
                    <section class=" flex space-x-2 w-full">
                        ...
                        <div class="form-group w-[50%] flex flex-col">
                            <label for="jurusan"
                                class=" font-semibold text-sm after:ml-0.5 after:text-red-500 after:content-['*']">Jurusan</label>
                            <input type="text" placeholder="Ex: Rekayasa Perangkat Lunak"
                                class="mt-1 w-full border rounded-sm px-2 py-1 border-border text-primary text-sm @error('jurusan') border-red-500 @enderror"
                    ...
                    <div class="form-group w-full flex flex-col">
                        <label for="asal sekolah"
                            class=" font-semibold text-sm after:ml-0.5 after:text-red-500 after:content-['*']">Asal
                            sekolah</label>
                        <input type="text" placeholder="Ex: SMK Negeri 2 Trenggalek"
                            class="mt-1 w-full border rounded-sm px-2 py-1 border-border text-primary text-sm @error('asal_sekolah') border-red-500 @enderror"
                    ...
                    <div class="form-group w-full flex flex-col">
                        <label for="konfirmasi password"
                            class=" font-semibold text-sm after:ml-0.5 after:text-red-500 after:content-['*']">Konfirmasi
                            password</label>
                        <div x-data="{ showPassword: false }"
                            class=" mt-1 w-full border rounded-sm px-2 py-1 border-border flex justify-between space-x-2">
                            <input x-bind:type="showPassword ? 'text' : 'password'" placeholder="Konfirmasi password"
                                class=" text-primary text-sm border-none outline-none w-full @error('konfirmasi_password') border-red-500 @enderror"
