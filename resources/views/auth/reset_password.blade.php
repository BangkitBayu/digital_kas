        ...
        <div class=" w-full flex items-center justify-center min-h-screen">
            <div class=" flex flex-col space-y-2 p-3 rounded-md w-full shadow-2xl max-w-90 lg:max-w-95 relative">
                <div class=" flex flex-col w-full text-center">
                    <h1 class=" text-xl font-semibold lg:text-2xl text-primary">Lupa Password?</h1>
                    <p class=" text-sm truncate-3 text-secondary">Masukkan akun kelas kamu untuk reset password.
                    </p>
                </div>
                <form method="POST" class=" w-full p-2 flex-col space-y-3">
                    ...
                    <div class="form-group w-full flex flex-col space-y-2">
                        ...
                        <label for="password"
                            class=" font-semibold text-sm after:ml-0.5 after:text-red-500 after:content-['*']">Password
                            Baru</label>
                    ...
                    <div class="form-group w-full flex flex-col space-y-2">
                        ...
                        <label for="password"
                            class=" font-semibold text-sm  after:text-red-500 after:content-['*']">Konfirmasi Password
                        </label>
                    ...
                    <button
                        class=" w-full p-2 bg-blue-500 rounded-sm text-sm text-blue-100 cursor-pointer">Submit</button>

                    <a href="{{ route('login') }}"
                        class=" text-sm font-normal text-center text-blue-500 hover:underline transition-all delay-200 ease-in">
                        <p>
