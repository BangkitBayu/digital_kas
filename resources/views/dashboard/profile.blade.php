...
<body class=" bg-[#fafafa] flex">
    ...
    <main class="container p-2 lg:w-[80vw]">
        <div class="container bg-white min-h-screen px-3 py-4 flex flex-col space-y-4">
            <div class="container">
                <h2 class=" font-semibold text-xl text-primary">Profile {{ $data->kelas }}</h2>
                <p class=" text-md text-secondary">Profile berisi seluruh detail akun kelas kamu.</p>
            </div>
            <div class="container border rounded-md border-[#d8d8d8da]">
                <div class="container flex items-center space-x-2 border-b p-2 border-[#d8d8d8da]">
                ...
                <form method="POST" class="p-3 flex flex-col space-y-3">
                    @csrf
                    <div class="form-group flex flex-col space-y-1">
                        ...
                        <input type="text" value="{{ $data->kelas }}"
                            class=" w-full border border-[#d8d8d8da] px-3 py-2 rounded-md focus:outline-blue-500 ease-in delay-100 text-sm text-secondary"
                            name="kelas">
                    </div>
                    <div class="form-group flex flex-col space-y-1">
                    ...
                    <div class="form-group w-full flex flex-col space-y-1">
                        <label for="new password" class=" text-md text-primary">Password baru</label>
                        <div x-data="{ showPassword: false }"
                            class=" w-full border border-[#d8d8d8da] rounded-md focus:outline-blue-500 ease-in delay-100 text-sm text-secondary flex">
                            <input x-bind:type="showPassword ? 'text' : 'password'" placeholder="Masukkan password baru"
                                class="px-3 py-2 text-primary text-sm border-none outline-none w-full @error('password') border-red-500 @enderror"
                                name="password_baru">
                            <button class=" bg-blue-500 px-3 py-2 rounded-r-md" id=" toggle-password" type="button"
                        ...
                        <div class="form-group w-full flex flex-col space-y-1">
                            ...
                            <div class="form-group w-full flex flex-col space-y-1">
                                <label for="password" class=" text-md text-primary">Password</label>
                                ...
                                <div x-data="{ showPassword: false }"
                                    ...
                                    <input x-bind:type="showPassword ? 'text' : 'password'" placeholder=""
                                        class="px-3 py-2 text-primary text-sm border-none outline-none w-full @error('password') border-red-500 @enderror"
                                        name="password">
                                    <button class=" bg-blue-500 px-3 py-2 rounded-r-md" id=" toggle-password"
                    ...
                    <button class=" text-white w-full px-3 py-2 rounded-md bg-blue-500 hover:bg-blue-400 transition-colors ease-in delay-150 mt-3" type="submit">Simpan perubahan</button>
            </div>
        </div>
    </main>
</body>
